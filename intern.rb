...
module EmailReportable
  #In here....I can make new methods...a collection of methods if you will
    def send_report
...
# intern can do everything a employee can do, but also can send a report
class Intern < Employee
  include EmailReportable
end
joe_bob = Manager.new({first_name: "Joe", last_name: "Bob", salary: 83849, active: true, employees: [employee1, employee2] })
intern1 = Intern.new({first_name: "Jane", last_name: "Doe", salary: 23000, active: true})
intern1.send_report
joe_bob.send_report
